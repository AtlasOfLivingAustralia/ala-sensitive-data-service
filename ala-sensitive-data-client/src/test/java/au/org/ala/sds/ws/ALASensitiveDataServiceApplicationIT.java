...
public class ALASensitiveDataServiceApplicationIT {
    ...
    public void testGetReport1() throws Exception {
        ...
        assertNotNull(report.getInstances());
        assertEquals(1, report.getInstances().size());
        assertEquals("ACT", report.getInstances().get(0).getZone().getId());
    }
    ...
    public void testGetReport2() throws Exception {
        ...
        assertNull(report.getInstances());
    }
