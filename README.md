# ALA Sensitive Data Service [![Build Status](https://api.travis-ci.com/AtlasOfLivingAustralia/ala-sensitive-data-service.svg?branch=maintenance-1.1)](https://app.travis-ci.com/AtlasOfLivingAustralia/ala-sensitive-data-service)
...
1. Start the application with `java -jar target/ala-sensitive-data-server-1.1.2-SNAPSHOT.jar server config.yml`
